...
MySQL - 10.4.17-MariaDB : Database - auebs
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`auebs` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `bill_table` (
  ...
  `pow_on_hrs` int(11) DEFAULT NULL,
  `avl_percent` int(11) DEFAULT NULL,
  ...
  `billing_demand` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `id` (`id`)
...
(1,'221','N100B','Johny Maldova','High','sdg','4',45,'45','45','2021-03-03',5,'75','sdgsdg','zsdvgzxdbv','xdbvzxcbv',75,74,421,420,425,'75','745','7547',574,666,'75','142','786','453','453','453','453','453','7867','786','7856','7856','785','785','786','78','7825','Bijay','Vendor','2021-03-03','2021-03-28',757),
(2,'221','112','Bibek Singh','Gen','LV','221',545,'545','76','2021-03-17',76,'Running','Pending','Silchar','jkhjk',89,89,89,76,76,'76','76','6',76,76,'6','76','768','54','76','7','45','46','64','46','454','353','24','242','645','46','46','Bijay','Staff','2021-03-17','2021-03-27',76),
(3,'741','147','Anand Singha','Gen','LV','45',4254,'54','76','2021-03-13',454,'Running','Pending','Silchar','jkhjk',867,785,78,7825,2578,'87','74','54',87,78,'54','21','21','765','87','7','741','741','74','747','7','','7','7','58','4','89','Bijay','Staff','2021-03-26','2021-03-31',21);
...
insert  into `users_table`(`id`,`meter_no`,`qtr_no`,`fname`,`lname`,`designation`,`dept`,`mob_no`,`email`,`uid`,`pwd`,`access_lvl`) values 
(3,'221','112','Bibek','Singh','Assistant Prof','Physics',2147483647,'babubilai@rediffmail.com','bib','bib',1),
(4,'301','103','Sandeepan ','Nath','Web Developer','CC',99874587,'sandy@gmail.com','301','301',1),
(5,'789','987','Subroto','Das','FMS',NULL,NULL,NULL,'789','987',1),
(7,'741','147','Anand','Singha','Network Engineer','CC',2147483647,'k.anand@hotmail.com','741','147',1);
